...
vim.keymap.set('n', '<Leader>f.', function()
  ...
  local pickers = {
    { text = "Files", action = function() snacks.picker.files() end },
    { text = "Buffers", action = function() snacks.picker.buffers() end },
    { text = "Recent", action = function() snacks.picker.recent() end },
    { text = "Live Grep", action = function() 
      if is_executable('rg') then
    ...
    { text = "Git Status", action = function()
      if is_executable('git') and is_git_repo() then
        snacks.picker.git_status()
      else
    ...
    { text = "LSP Symbols", action = function()
      if has_lsp_client() then
        snacks.picker.lsp_symbols()
      else
    ...
    { text = "Help", action = function() snacks.picker.help() end },
    { text = "Commands", action = function() snacks.picker.commands() end },
  }
